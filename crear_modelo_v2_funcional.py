"""
Script para que Igor cree el modelo v2 CORRECTAMENTE
Ejecutar: python crear_modelo_v2_funcional.py
"""
...
print("="*70)
print("CREACIÓN DE MODELO DE SEGURIDAD V2 - VERSIÓN FUNCIONAL")
print("="*70)

# Opción del usuario
print("\nSelecciona el tipo de modelo:")
print("1. Modelo CNN Simple (rápido, menor accuracy)")
print("2. Transfer Learning MobileNetV2 (más lento, mejor accuracy)")

opcion = input("\nIngresa 1 o 2 [default: 1]: ").strip() or "1"
...
if opcion == "2":
    ...
    ], name='modelo_seguridad_v2_transfer')
    ...
    ], name='modelo_seguridad_v2_simple')
...
try:
    ...
    print("💾 Guardando modelo_seguridad_v2.h5...")
    model.save('models/modelo_seguridad_v2.h5')
    print("✅ Guardado exitosamente!")
    
    # Guardar formato Keras nativo
    print("💾 Guardando modelo_seguridad_v2.keras...")
...
try:
    # Probar .h5
    print("🔄 Cargando modelo_seguridad_v2.h5...")
    loaded_h5 = keras.models.load_model('models/modelo_seguridad_v2.h5', compile=False)
    ...
    # Probar .keras
    print("\n🔄 Cargando modelo_seguridad_v2.keras...")
    loaded_keras = keras.models.load_model('models/modelo_seguridad_v2.keras', compile=False)
...
print("\n" + "="*70)
print("VERIFICACIÓN 3: Script de Prueba Completo")
print("="*70)
print("Ejecuta ahora: python test_modelo_v2.py")
print("Si pasa todas las pruebas → ✅ Listo para commit")

# Resumen final
print("\n" + "="*70)
print("✅ ¡MODELO V2 CREADO EXITOSAMENTE!")
print("="*70)
print("\n📁 Archivos generados:")
print("   - models/modelo_seguridad_v2.h5")
print("   - models/modelo_seguridad_v2.keras")

print("\n📋 Checklist:")
print("   ✅ Modelo creado sin errores")
print("   ✅ Arquitectura verificada")
print("   ✅ Predicción de prueba funciona")
print("   ✅ Modelos guardados correctamente")
print("   ✅ Modelos pueden cargarse sin errores")

print("\n🎯 Próximos pasos:")
print("   1. Ejecutar: python test_modelo_v2.py")
print("   2. Si pasa las pruebas → git add models/modelo_seguridad_v2.*")
print("   3. git commit -m 'Modelo v2 funcional corregido'")
print("   4. git push origin igor/cnn-model")
print("   5. Notificar a Daniel que el modelo está listo")
