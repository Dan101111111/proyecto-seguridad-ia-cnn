"""
Script de prueba para el modelo de seguridad v2 de Igor
...
if __name__ == "__main__":
    print("🔒 SISTEMA DE PRUEBA DE MODELO DE SEGURIDAD V2")
    print("Desarrollado por el equipo de IA/Seguridad\n")
    
    # Probar modelo v2 en formato .h5
    print("\n" + "="*60)
    print("TEST 1: Modelo v2 formato HDF5 (.h5)")
    print("="*60)
    resultado_h5 = test_model('models/modelo_seguridad_v2.h5')
    
    # Probar modelo v2 en formato .keras
    print("\n\n" + "="*60)
    print("TEST 2: Modelo v2 formato Keras (.keras)")
    print("="*60)
    resultado_keras = test_model('models/modelo_seguridad_v2.keras')
    ...
    if resultado_h5 and resultado_keras:
        ...
        print("💡 Recomendación: Usar modelo_seguridad_v2.keras (formato más reciente)")
        print("\n📝 Próximos pasos:")
        print("   1. Actualizar config.json para usar modelo v2")
